...
const ServiceDetailSkeleton = () => {
    return (
        <>
            <section className="lg:pt-9.375! pt-24! lg:pb-16! pb-0! relative before:content-[''] before:absolute lg:before:h-full before:h-1/5 before:bg-no-repeat before:-z-1 before:bg-[url('/images/hero/right-background.jpg')] before:bg-cover before:right-0 lg:before:top-0 before:bottom-0 lg:before:w-40% before:w-full after:content-[''] after:absolute after:-z-1 after:bg-grey dark:after:bg-darklight after:h-full lg:after:w-60%  after:w-full after:left-0 after:top-0">
